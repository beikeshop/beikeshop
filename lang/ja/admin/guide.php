...
return [
    ...
    'text_language_1'              => 'BeikeShop システムは複数の言語と通貨をサポートしています。最初の商品の作成を開始する前に、モールのフロント デスクでデフォルトの言語と通貨を選択できます。',
    'text_language_2'              => '1 つの言語と通貨のみを使用する必要がある場合は、他の言語と通貨を削除できます。商品作成時に多言語で情報を入力する手間を省きます。',
    ...
    'text_theme_1'                 => 'システムには、デフォルトでインストールされた一連のデフォルトのテーマテンプレートがあります。デフォルトのテーマがニーズを満たさない場合は、<a href="' . admin_route('marketing.index', ['type' => 'theme']) . '">プラグイン マーケット</a>で他のテンプレート テーマを購入します。',
    ...
    'text_payment_4'               => 'BeikeShop<a href="' . admin_route('marketing.index') . '">「プラグイン マーケット」</a>にアクセスして、その他の支払い方法とロジスティクスを確認およびダウンロードすることもできます。',
    ...
    // Error
    'error_permission'             => 'エラー: 初心者ガイドを変更する権限がありません!',
];
