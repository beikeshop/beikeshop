...
return [
    ...
    'btn_color'                => '버튼 글자색',
    'module_size'              => '모듈 너비',
    'module_size_narrow'       => '좁은 화면',
    'module_size_wide'         => '넓은 화면',
    'module_size_full'         => '전체 화면',
    ...
    'type'                   => '유형',
    'scroll_text'            => '스크롤 텍스트',
    'scroll_text_color'      => '색상',
    'scroll_text_bg'         => '배경색',
    'scroll_text_size'       => '크기',
    'scroll_text_padding'    => '상하 여백',
    'header_ads'             => '헤더 광고',
    'header_ads_bg'          => '광고 배경색',
    'header_ads_info'        => '광고 내용',
    ...
    'social_media_icons' => '소셜 미디어 아이콘',
    'image_alt'          => '이미지 설명',
    'image_alt_info'     => '이미지 설명은 alt 태그로, 이미지가 표시되지 않을 경우 대체 텍스트를 제공하며 접근성과 SEO 효과를 높입니다.',
    'layout_modules'     => '내비게이션',
    'effect_preview'     => '효과 미리보기',
    'image_position'     => '이미지 위치',
    'text_position'      => '텍스트 위치',
    'text_max_width'     => '텍스트 최대 너비',
];
