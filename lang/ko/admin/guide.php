...
return [
    ...
    // Tab
    'tab_basic'                    => '기본 설정',
    'tab_language'                 => '다양한 언어 및 통화',
    'tab_product'                  => '제품 생성',
    'tab_theme'                    => '상점 장식',
    'tab_payment_shipping'         => '결제 및 물류',
    'tab_mail'                     => '구성 메일',
    ...
    'text_language_1'              => 'BeikeShop 시스템은 다양한 언어와 통화를 지원합니다. 첫 번째 제품 제작을 시작하기 전에 쇼핑몰 프론트 데스크에서 기본 언어와 통화를 선택할 수 있습니다!',
    'text_language_2'              => '하나의 언어와 통화만 사용해야 하는 경우 다른 언어와 통화를 삭제할 수 있습니다. 제품을 만들 때 다국어로 정보를 입력해야 하는 번거로움을 피하세요.',
    ...
    'text_theme_1'                 => '시스템에는 기본적으로 기본 테마 템플릿 세트가 설치되어 있습니다. 기본 테마가 요구 사항을 충족하지 않는 경우 <a href="' . admin_route('marketing.index', ['type' => 'theme']) . '">플러그인 마켓</a>을 통해 다른 템플릿 테마를 구매하세요.',
    ...
    'text_payment_1'               => 'BeikeShop은 기본 PayPal, Stripe 등 일반적으로 사용되는 해외 결제 채널을 제공합니다. 공식적으로 주문하기 전에 해당 결제 방법을 활성화하고 구성해야 합니다.',
    'text_payment_2'               => '참고: 일부 결제 인터페이스 애플리케이션은 검토하는 데 시간이 더 오래 걸리므로 미리 신청하시기 바랍니다. 중국에서 사용되는 결제 방법에는 웹사이트 도메인 이름 등록이 필요할 수 있습니다.',
    'text_payment_3'               => '또한 고객이 선택할 수 있는 물류 배송 방법도 설정해야 합니다. 시스템은 고정 배송비 플러그인을 무료로 제공합니다.',
    'text_payment_4'               => 'BeikeShop<a href="' . admin_route('marketing.index') . '">"플러그인 마켓"</a>으로 이동하여 더 많은 결제 방법과 물류 방법을 알아보고 다운로드할 수도 있습니다.',
    ...
    // Error
    'error_permission'             => '오류: 초보 가이드를 수정할 권한이 없습니다!',
];
