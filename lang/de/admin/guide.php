...
return [
    ...
    'tab_language'                 => 'Mehrere Sprachen und Währungen',
    'tab_product'                  => 'Produkt erstellen',
    'tab_theme'                    => 'Shop-Dekoration',
    'tab_payment_shipping'         => 'Zahlung und Logistik',
    ...
    'text_language_1'              => 'Das BeikeShop-System unterstützt mehrere Sprachen und Währungen. Bevor Sie mit der Erstellung Ihres ersten Produkts beginnen, können Sie an der Rezeption des Einkaufszentrums die Standardsprache und -währung auswählen!',
    'text_language_2'              => 'Wenn Sie nur eine Sprache und Währung verwenden müssen, können Sie die anderen Sprachen und Währungen löschen. Vermeiden Sie beim Erstellen von Produkten die mühsame Eingabe von Informationen in mehreren Sprachen.',
    ...
    'text_payment_1'               => 'BeikeShop bietet häufig verwendete Zahlungskanäle im Ausland, wie z. B. das Standard-PayPal, Stripe usw. Bevor Sie offiziell eine Bestellung aufgeben, müssen Sie die entsprechende Zahlungsmethode aktivieren und konfigurieren.',
    'text_payment_2'               => 'Hinweis: Die Prüfung einiger Anträge für Zahlungsschnittstellen dauert länger. Bitte bewerben Sie sich im Voraus. In China verwendete Zahlungsmethoden erfordern möglicherweise die Registrierung eines Website-Domainnamens.',
    'text_payment_3'               => 'Darüber hinaus müssen Sie auch die Logistik-Liefermethode festlegen, die Kunden auswählen können. Das System bietet ein kostenloses Plug-in mit festen Versandkosten.',
    'text_payment_4'               => 'Sie können auch zu BeikeShop<a href="' . admin_route('marketing.index') . '">"Plug-in Market"</a> gehen, um mehr Zahlungsmethoden und Logistik zu erfahren und herunterzuladen Methoden!',
    ...
    'button_language'              => 'Sprachverwaltung',
    ...
    'button_payment'               => 'Zahlungsmethode',
    ...
    // Error
    'error_permission'             => 'Fehler: Sie haben keine Berechtigung, den Leitfaden für Anfänger zu ändern!',
];
