...
return [
    ...
    'tab_language'                 => 'Più lingue e valute',
    ...
    'text_language_1'              => 'Il sistema BeikeShop supporta più lingue e valute. Prima di iniziare a creare il tuo primo prodotto, puoi selezionare la lingua e la valuta predefinite alla reception del centro commerciale!',
    'text_language_2'              => 'Se hai bisogno di utilizzare solo una lingua e una valuta, puoi eliminare le altre lingue e valute. Evita il fastidio di inserire informazioni in più lingue durante la creazione dei prodotti.',
    ...
    'text_payment_4'               => 'Puoi anche andare su BeikeShop<a href="' . admin_route('marketing.index') . '">"Plug-in Market"</a> per scoprire e scaricare altri metodi di pagamento e logistica.',
    ...
    'button_language'              => 'Gestione della lingua',
    ...
    // Error
    'error_permission'             => 'Errore: non hai il permesso di modificare la guida per principianti!',
];
