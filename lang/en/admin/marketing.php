...
return [
    ...
    'token_verify_failed'            => 'Developer token verification failed, not saved',
    'copy_token_hint'                => 'Please copy the developer token from the official website personal center and paste it here',
];
