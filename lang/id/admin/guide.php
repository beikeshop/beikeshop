...
return [
    ...
    'tab_language'                 => 'Beberapa bahasa dan mata uang',
    ...
    'text_language_1'              => 'Sistem BeikeShop mendukung berbagai bahasa dan mata uang. Sebelum Anda mulai membuat produk pertama, Anda dapat memilih bahasa dan mata uang default di meja depan mal!',
    'text_language_2'              => 'Jika Anda hanya perlu menggunakan satu bahasa dan mata uang, Anda dapat menghapus bahasa dan mata uang lainnya. Hindari kerumitan memasukkan informasi dalam berbagai bahasa saat membuat produk.',
    ...
    'text_theme_1'                 => 'Sistem memiliki seperangkat templat tema default yang terinstal secara default. Jika tema default tidak memenuhi kebutuhan Anda, Anda juga dapat menggunakan <a href="' . admin_route('marketing.index', ['type' => 'theme']) . '">Pasar Plugin</a> untuk membeli tema templat lainnya.',
    ...
    'text_payment_4'               => 'Anda juga dapat mengunjungi BeikeShop<a href="' . admin_route('marketing.index') . '">"Plug-in Market"</a> untuk mempelajari dan mengunduh lebih banyak metode pembayaran dan logistik.',
    ...
    'button_language'              => 'Manajemen bahasa',
    ...
    // Error
    'error_permission'             => 'Kesalahan: Anda tidak memiliki izin untuk memodifikasi panduan pemula!',
];
