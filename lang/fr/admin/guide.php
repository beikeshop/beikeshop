...
return [
    ...
    'tab_language'                 => 'Plusieurs langues et devises',
    ...
    'text_language_1'              => 'Le système BeikeShop prend en charge plusieurs langues et devises. Avant de commencer à créer votre premier produit, vous pouvez sélectionner la langue et la devise par défaut à la réception du centre commercial !',
    'text_language_2'              => 'Si vous n\'avez besoin d\'utiliser qu\'une seule langue et devise, vous pouvez supprimer les autres langues et devises. Évitez les tracas liés à la saisie d\'informations dans plusieurs langues lors de la création de produits.',
    ...
    'text_payment_4'               => 'Vous pouvez également accéder à BeikeShop<a href="' . admin_route('marketing.index') . '">"Plug-in Market"</a> pour découvrir et télécharger davantage de méthodes de paiement et de logistique.',
    ...
    'button_language'              => 'Gestion des langues',
    ...
    // Error
    'error_permission'             => 'Erreur : Vous n\'avez pas la permission de modifier le guide du débutant !',
];
