...
return [
    'can_empty'               => '空にすることはできません',
    'click_upload'            => 'クリックしてアップロードするか、画像をここにドラッグ',
    ...
    'file_manager_show'       => 'ディレクトリ/ファイルを表示',
    'file_manager_update'     => 'rename',
    'file_name'               => 'ファイル名です',
    'file_sorting'            => 'ファイルの並べ替えです',
    'finish'                  => '終了',
    ...
    'target_not_exist'        => '元のファイルまたはフォルダーが存在しません',
    'text_asc'                => '順番です',
    'text_created'            => '作成時間です',
    'text_desc'               => '逆順です',
    'text_type'               => 'タイプです',
    'to_sort'                 => '順序付けです',
    'upload_fail'             => 'アップロード失敗しました',
    'upload_files'            => 'ファイルをアップロード',
    'uploading'               => 'アップロード中',
    'verify_select_image'     => '画像をお願いします。',
    'verify_select_video'     => 'ビデオをお願いします',
];
