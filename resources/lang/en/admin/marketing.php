...
return [
    ...
    'attention_show_2'        => 'Each plugin purchase is only authorized to be used in the corresponding purchased domain name! It is prohibited to use multiple domain names in one purchase, and any violation will be held legally responsible!',
    'attention_show_3'        => 'Software is a special product, after paying for the purchase of non-software itself problems do not support refund, please read the plug-in description carefully before purchase',
