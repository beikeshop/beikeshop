...
return [
    ...
    'amount'                  => '訂單金額',
    'attention_1'             => '請注意：',
    'attention_2'             => '每次插件購買，只授權在對應購買域名中使用！禁止一次購買在多個域名中使用，任何違規行爲將被追究法律責任！',
    'attention_3'             => '虛擬商品,非軟件本身問題,概不退換。',
    'attention_show_1'        => '注意事項：',
    'attention_show_2'        => '每次插件購買，只授權在對應購買域名中使用！禁止一次購買在多個域名中使用，任何違規行爲將被追究法律責任！',
    'attention_show_3'        => '軟件爲特殊商品，付費購買後非軟件本身問題不支持退款，請購買前請仔細閱讀插件說明',
