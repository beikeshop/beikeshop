<template id="module-editor-img-text-banner-multiple-template">
...
Vue.component('module-editor-img-text-banner-multiple', {
  template: '#module-editor-img-text-banner-multiple-template',
