          ...
          <div class="tab-pane fade show active" id="tab-basic">
            ...
            <div>
                        ...
                        <tbody>
                          <tr v-for="(sku, skuIndex) in form.skus" :key="skuIndex">
                            ...
                            <td><input type="number" class="form-control" v-model="sku.origin_price" :name="'skus[' + skuIndex + '][origin_price]'" step="any"
                                placeholder="{{ __('admin/product.origin_price') }}" required></td>
                            <td><input type="number" class="form-control" v-model="sku.cost_price" :name="'skus[' + skuIndex + '][cost_price]'" step="any"
                                placeholder="{{ __('admin/product.cost_price') }}" required>
                            </td>
              ...
              <template v-if="!editing.isVariable">
                ...
                <x-admin-form-input name="skus[0][cost_price]" type="number" :title="__('admin/product.cost_price')" :value="old('skus.0.cost_price', $product->skus[0]->cost_price ?? '')" step="any" required />
