...
class MenuProviderMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'plugin:menu-provider';
     ...
     * @var string
     */
    protected $description = 'Create a new menu service provider for the specified plugin.';
    ...
    protected function getTemplateContents()
    {
        ...
        return (new Stub('/menu-provider.stub', [
