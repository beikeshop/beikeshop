...
class InterfaceMakeCommand extends GeneratorCommand
{
    ...
    protected $name = 'plugin:make-interface';
    protected $description = 'Create a new interface class for the specified plugin.';

    public function getDestinationFilePath(): string
    {
        $path = $this->laravel['plugins']->getModulePath($this->getModuleName());

        $filePath = GenerateConfigReader::read('interfaces')->getPath() ?? config('plugins.paths.app_folder') . 'Interfaces';
    ...
    {
        return config('plugins.paths.generator.interfaces.namespace', 'Interfaces');
    }
