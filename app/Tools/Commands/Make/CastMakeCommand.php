...
class CastMakeCommand extends GeneratorCommand
{
    ...
    protected $name = 'plugin:make-cast';
    protected $description = 'Create a new Eloquent cast class for the specified plugin.';

    public function getDestinationFilePath(): string
    {
        $path = $this->laravel['plugins']->getModulePath($this->getModuleName());

        $filePath = GenerateConfigReader::read('casts')->getPath() ?? config('plugins.paths.app_folder') . 'Casts';
    ...
    {
        return config('plugins.paths.generator.casts.namespace', 'Casts');
    }
