...
class RequestMakeCommand extends GeneratorCommand
{
    ...
    {
        return config('plugins.paths.generator.request.namespace')
            ?? ltrim(config('plugins.paths.generator.request.path', 'Http/Requests'), config('plugins.paths.app_folder', ''));
    }
