...
class SeedCommand extends BaseCommand
{
    ...
    public function executeAction($name): void
    {
        ...
        $this->components->task("Seeding <fg=cyan;options=bold>{$module->getName()}</> Plugin", function () use ($module) {
            try {
    ...
    /**
     * Get master database seeder name for the specified module under a different namespace than plugins.
     *
     * @param string $name
     *
