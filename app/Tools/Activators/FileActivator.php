...
class FileActivator implements ActivatorInterface
{
    ...
    private function getModulesStatuses(): array
    {
        ...
        return $this->cache->store($this->config->get('plugins.cache.driver'))->remember($this->cacheKey, $this->cacheLifetime, function () {
            return $this->readJson();
        });
    }
    ...
    {
        $this->cache->store($this->config->get('plugins.cache.driver'))->forget($this->cacheKey);
    }
}
