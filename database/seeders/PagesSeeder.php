    ...
    public function getPages()
    {
        return [
            ...
            [
                ...
                "position" =>0,
                "views" =>1,
                "image" => '/image/catalog/demo/blog/post-1.webp',
                "author" =>"BeikeShop",
                "active" =>1,
            ],
            [
                ...
                "position" =>0,
                "views" =>1,
                "image" => '/image/catalog/demo/blog/post-2.webp',
                "author" =>"BeikeShop",
                "active" =>1,
            ],
            [
                ...
                "position" =>0,
                "views" =>1,
                "image" => '/image/catalog/demo/blog/post-3.webp',
                "author" =>"BeikeShop",
                "active" =>1,
            ],
            [
                ...
                "position" =>0,
                "views" =>1,
                "image" => '/image/catalog/demo/blog/post-4.webp',
                "author" =>"BeikeShop",
                "active" =>1,
            ],
        ];
