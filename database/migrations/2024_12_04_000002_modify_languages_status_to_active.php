...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        if (!in_array('active', $columns) && in_array('status', $columns)) {
            ...
            DB::statement('UPDATE languages SET active = CASE WHEN status = 1 THEN 1 ELSE 0 END');
    ...
    public function down()
    {
        ...
        DB::statement('UPDATE languages SET status = CASE WHEN active = 1 THEN 1 ELSE 0 END');
