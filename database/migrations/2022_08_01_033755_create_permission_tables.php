...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create($tableNames['permissions'], static function (Blueprint $table) {
            ...
            $table->string('guard_name')->comment('权限所属组'); // For MyISAM use string('guard_name', 25);
            $table->timestamps();
        ...
        Schema::create($tableNames['roles'], static function (Blueprint $table) use ($teams, $columnNames) {
            ...
            $table->string('guard_name')->comment('所属权限组'); // For MyISAM use string('guard_name', 25);
            $table->timestamps();
        ...
        Schema::create($tableNames['model_has_permissions'], static function (Blueprint $table) use ($tableNames, $columnNames, $pivotPermission, $teams) {
            ...
            $table->comment('模型权限');
            $table->unsignedBigInteger($pivotPermission)->comment('权限 ID');
