...
class Wintopay
{
    ...
    public function __construct()
    {
        ...
        $this->config = [
            ...
            // 没有州的国家
            'countryNoState' => ['AF', 'AX', 'AT', 'BH', 'BB', 'BE', 'BZ', 'BA', 'BG', 'BI', 'HR', 'CW', 'CZ', 'DK', 'EE', 'ET', 'FI', 'FR', 'GF', 'DE', 'GR', 'GP', 'GG', 'HU', 'IS', 'IR', 'IM', 'IL', 'KW', 'LV', 'LB', 'LI', 'LU', 'MT', 'MQ', 'YT', 'NL', 'NZ', 'NO', 'PL', 'PT', 'PR', 'RE', 'RW', 'MF', 'RS', 'SG', 'SK', 'SI', 'KR', 'LK', 'SE', 'CH', 'AE', 'GB', 'VN'],

            // 没有邮编的国家
            'countryNoZipcode' => ['BH', 'BD', 'CL', 'CO', 'GH', 'HK', 'IE', 'JM', 'NP', 'UG', 'VN', 'ZW', 'BO', 'MZ', 'NL', 'NG', 'NO', 'WS', 'ST', 'AO', 'BS', 'BH', 'BD', 'BZ', 'BO', 'CL', 'CO', 'CW', 'GH', 'GT', 'HK', 'IE', 'JM', 'MZ', 'NP', 'NG', 'KN', 'WS', 'UG', 'AE', 'VN', 'ZW'],
