...
@section('content')
  <div class="install-1">
    ...
    <div class="content-main d-flex justify-content-center align-items-center flex-column">
      <div class="welcome-img"><img width="600" height="400" src="https://beikeshop.com/install/install-1.png?version={{ config('beike.version') }}&build_date={{ config('beike.build') }}" class="img-fluid"></div>
