...
return [
    ...
    'welcome'      => [
        ...
        'copyright_text' => '感谢您选择使用BeikeShop搭建您的网站。我们在此提醒，本软件仅供合法的电商建站经营者使用。使用本软件进行非法活动所产生的一切后果与BeikeShop无关。
        请您在使用本软件时遵守所在国家和地区的相关法律法规，对于因违法行为而导致的一切法律责任，将由使用者自行承担，BeikeShop不承担任何责任！
        特此声明。',
    ],
